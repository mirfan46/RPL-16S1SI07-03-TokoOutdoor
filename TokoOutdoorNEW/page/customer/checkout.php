...
//-- memanggil invoice yang difungsikan pada echo.
?>
...
<body>
	...
	<nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-danger fixed-top">
		<div class="container">
			<a class="navbar-brand" href="../../index.php" style="font-size: 30px;">TOKOOUTDOOR</a>
	...
	<br>
		<?php
		if(isset($_POST['simpan'])){ //1. if isset berfungsi untuk melakukan posting simpan pada submit form
			$no_invoice = $_POST['no_invoice']; //2. melakukan post $no_invoice dengan query no_invoice sesuai form, untuk no_invoice sudah auto generate jadi tidak perlu diinputkan lagi.
			$nama_penerima = $_POST['nama_penerima']; //3. melakukan proses input nama_penerima lalu disambungkan melalui post pada query ke database
			$kode_pos = $_POST['kode_pos'];  
			$alamat = $_POST['alamat']; 
			$no_telp = $_POST['no_telp'];
			$metode_pem = $_POST['metode_pem'];
			//4. melakukan proses input nama_penerima, kodepos, alamat, no_telp, metode_pem lalu disambungkan melalui post pada query ke database
			//5. query INSERT INTO Berfungsi untuk mengeksekusi input dengan perintah post dari POST diatas.
			$query = " 
				...
				<div class="col-md-6">
					...
					<form method="post" action="">		
						<div class="form-group">
						 ...
						 <!--6. Input name="no_invoice, (echo no_invoice berfungsi memanggil no_inovice yang telah terinput generate untuk di tampilkan pda form) nama_penerima, kode_pos, alamat, no_telp dan " berfungsi sebagai penghubung pada actdaftar.php sebagai deklarasi dari $email-->
						</div>
						<div class="form-group">
...
<!-- 
						<?php
						//7. Script code raja Ongkir masih belum dapat digunakan untuk penggunaan dari raja ongkir sendiri yaitu dengan input URL dengan CURLOPT dan di aktifkan true.
