...
<body>
  ...
  <nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-danger fixed-top">
    <div class="container">
      <a class="navbar-brand" href="index.php" style="font-size: 30px;">TOKO OUTDOOR</a>
  ...
  <?php
  $kd = $_GET['id_barang'];
  $q_detail = mysqli_query($conn, "SELECT * from tb_barang where id_barang='$id'");
...
<!-- 
           <?php
                ...
                ?>
                <a href="page/customer/proses_beli.php?id_barang=<?=$kd['id_barang']?>" class="<?php echo $disable;?>">Beli</a>
 -->
